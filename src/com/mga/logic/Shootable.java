...
/**
 *This exists so that Projectile can collide and use onHit and Enemy can interact.
 * @author Nicky
 *
 */
public abstract class Shootable extends CollisionObject {
	...
	/**
	 * OnHit does whatever is supposed to happen when this object hits a projectile.
	 * @param p
	 */
